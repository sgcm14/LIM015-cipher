const cipher = {
  ...
  encode: (offset, frase) => {
    ...
    if (Number.isNaN(offset) || offset == null || offset === 0 || Array.isArray(frase)) {
    ...
    for (let i = 0; i < frase.length; i += 1) {
      ...
      if (indiceLetra >= 65 && indiceLetra <= 90) {
        ...
        if (offset > 0) {
          ...
          indiceLetra = (((indiceLetra - 65 + parseInt(offset, 10)) % 26) + 65);
        } else {
          // aplicando formula cifrado cesar si el offset es negativo
          indiceLetra = (((indiceLetra - 90 + parseInt(offset, 10)) % 26) + 90);
        }
        ...
        if (offset > 0) {
          // aplicando formula cifrado cesar si el offset es positivo
          indiceLetra = (((indiceLetra - 97 + parseInt(offset, 10)) % 26) + 97);
        } else {
          // aplicando formula cifrado cesar si el offset es negativo
          indiceLetra = (((indiceLetra - 122 + parseInt(offset, 10)) % 26) + 122);
        }
        // retornando la nueva letra de acuerdo la nueva posicion
        nuevaFrase += String.fromCharCode(indiceLetra);
        ...
        if (offset > 0) {
          // aplicando formula cifrado cesar si el offset es positivo
          // indiceLetra = (((indiceLetra - 32 + parseInt(offset, 10)) % 33) + 32);
          indiceLetra;
        }
        // retornando la nueva letra de acuerdo la nueva posicion
        nuevaFrase += String.fromCharCode(indiceLetra);
  ...
  decode: (offset, frase) => {
    ...
    for (let i = 0; i < frase.length; i += 1) {
      ...
      if (indiceLetra >= 65 && indiceLetra <= 90) {
        ...
        if (offset > 0) {
          // aplicando formula cifrado cesar si el offset es positivo
          // indiceLetra = (((indiceLetra - 64 - parseInt(offset, 10)) % 33) + 64);
          indiceLetra;
        }
        // retornando la nueva letra de acuerdo la nueva posicion
        nuevaFrase += String.fromCharCode(indiceLetra);
